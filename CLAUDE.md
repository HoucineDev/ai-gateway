...
routing (latency EWMA + vLLM queue pressure + local admission control), exact response cache. Next: Azure OpenAI / Gemini-Vertex / Bedrock adapters, provider invoice reconciliation, load-test harness.
